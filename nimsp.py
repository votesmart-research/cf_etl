...
def save_transformed(df: pandas.DataFrame):
...
def main():
    ...
    records_extracted, json_extract = extract(YEAR, EXPORT_DIR)
    ...
    records_transformed, df_transformed = transform(records_extracted)
